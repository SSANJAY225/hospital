      ...
      <div className='admin-container2'>
        <div className='admin-panel'>
          <div className='admin-buttons'>
            {(roll === 'admin') && (
              <>
                <Link to={`/adminfollow?loginlocation=${username}&franchiselocation=${franchiselocation}`} className='btn-default'>Patients</Link>
            ...
            {(roll === 'doctor\r\n' || roll === 'doctor') && (
              <>
                <Link to={`/PatientsFollowUpIn?loginlocation=${username}&franchiselocation=${franchiselocation}`} className='btn-default'>
                  Appointments (InPatients) - {patientCounts.inpatient_count}
                </Link>
                <Link to={`/PatientsFollowUpOut?loginlocation=${username}&franchiselocation=${franchiselocation}`} className='btn-default'>
