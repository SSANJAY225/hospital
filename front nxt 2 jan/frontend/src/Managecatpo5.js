...
function ManageTreatments() {
  ...
  useEffect(() => {
    const fetchTreatments = async () => {
      try {
        const response = await axios.get('http://amrithaahospitals.visualplanetserver.in/treatmentgiven');
  ...
  const handleUpdateTreatment = async () => {
    try {
      await axios.put(`http://amrithaahospitals.visualplanetserver.in/treatmentgiven/${selectedTreatment.id}`, {
  ...
  const handleDeleteTreatment = async (treatment) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`http://amrithaahospitals.visualplanetserver.in/treatmentgiven/${treatment.id}`);
