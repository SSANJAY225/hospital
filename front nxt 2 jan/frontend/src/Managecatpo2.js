...
function ManageExaminations() {
  ...
  useEffect(() => {
    const fetchExaminations = async () => {
      try {
        const response = await axios.get('http://amrithaahospitals.visualplanetserver.in/examinations');
  ...
  const handleUpdateExamination = async () => {
    try {
      await axios.put(`http://amrithaahospitals.visualplanetserver.in/examinations/${selectedExamination.id}`, {
  ...
  const handleDeleteExamination = async (examination) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`http://amrithaahospitals.visualplanetserver.in/examinations/${examination.id}`);
  ...
  const handleAddExamination = async() => {
    ...
    try {
      await axios.post('http://amrithaahospitals.visualplanetserver.in/addExamination', {
