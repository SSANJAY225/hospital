...
const AppoinmentPublic = () => {
  ...
  useEffect(() => {
    ...
    if (patient.phoneNumber.length === 10) {
      // Debounce API calls to prevent rapid re-fetching
  ...
  }, [patient.phoneNumber]); // Only depend on phoneNumber
...
export default AppoinmentPublic;