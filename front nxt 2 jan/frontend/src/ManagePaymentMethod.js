...
function ManagePaymentMethod() {
  ...
  const fetchDoctorEntries = async () => {
    try {
      const response = await axios.get('http://amrithaahospitals.visualplanetserver.in/get-paymentMethod');
  ...
  const handleUpdateDoctor = async () => {
    ...
    try {
      await axios.put(`http://amrithaahospitals.visualplanetserver.in/update-PaymentMethod/${selectedDoctor.payment_id}`, {
  ...
  const handleDeleteDoctor = async (doctor) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`http://amrithaahospitals.visualplanetserver.in/delete-paymentMethod/${doctor.payment_id}`);
