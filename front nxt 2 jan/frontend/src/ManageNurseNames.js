...
function ManageNurseNames() {
  ...
  const fetchNurseEntries = async () => {
    try {
      const response = await axios.get('https://amrithaahospitals.visualplanetserver.in/nurses_name');
  ...
  const handleAddNurse = async () => {
    ...
    try {
      await axios.post('https://amrithaahospitals.visualplanetserver.in/nurses_name', {
        name: newNurseName,
      });
  ...
  const handleUpdateNurse = async () => {
    ...
    try {
      await axios.put(`https://amrithaahospitals.visualplanetserver.in/nurses_name/${selectedNurse.id}`, {
        name: newNurseName,
      });
      await fetchNurseEntries();
      setModalIsOpen(false);
  ...
  const handleDeleteNurse = async (nurse) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://amrithaahospitals.visualplanetserver.in/nurses_name/${nurse.id}`);
          await fetchNurseEntries();
          Swal.fire({
            icon: 'success',
            title: 'Deleted!',
