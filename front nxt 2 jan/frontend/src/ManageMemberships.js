...
function ManageMemberships() {
  ...
  const fetchMembershipEntries = async () => {
    try {
      const response = await axios.get('https://amrithaahospitals.visualplanetserver.in/memberships');
  ...
  const handleAddMembership = async () => {
    ...
    try {
      await axios.post('https://amrithaahospitals.visualplanetserver.in/memberships', {
  ...
  const handleUpdateMembership = async () => {
    ...
    try {
      await axios.put(`https://amrithaahospitals.visualplanetserver.in/memberships/${selectedMembership.membership_type}`, {
        membership_type: newMembershipType,
        price: newPrice ? priceValue : null,
      });
      await fetchMembershipEntries();
  ...
  const handleDeleteMembership = async (membership) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://amrithaahospitals.visualplanetserver.in/memberships/${membership.membership_type}`);
          await fetchMembershipEntries();
          Swal.fire({
            icon: 'success',
            title: 'Deleted!',
